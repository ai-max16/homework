  ...
  <div class="row justify-content-center">
    <div class="col-md-5">
      ...
      <form method="POST" action="{{ route('mypage') }}">
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between">
            <label for="nickname" class="text-md-left">ニックネーム</label>
          </div>
          <div class="collapse show editUserPhone">
            <input id="phone" type="text" class="form-control @error('nickname') is-invalid @enderror" name="nickname" value="{{ $user->nickname }}" required autocomplete="nickname" autofocus placeholder="たろう">
            @error('nickname')
            <span class="invalid-feedback" role="alert">
